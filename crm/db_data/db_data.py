...
class DbData(PreDataBase):
    def __init__(self):
        ...
        self.detla = (datetime.datetime.now() - datetime.timedelta(days=1)).strftime('%Y-%m-%d %H:%M:%S')
...
('2222457', '2222458', '{0}', '13621236449', '1235469', '2', '0', '18052912jkd1', 'smscontent 13214521144', '{1}');""".format(self.detla, self.detla)
            # print sql
            time.sleep(3)
            self.db.execute_sql(sql)
...
('2222457', '2222458', '{0}', '6', '6', 'wlq产品1', '59900', '3399', '10', '2', '1', '{1}', NULL, NULL, NULL, NULL, NULL, 'ddd', '172.168.14.143', '-1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', '{2}', '{3}', NULL, NULL, NULL, NULL, '{4}', '{5}');
            """.format(rdn, i, rdn2, i+1, self.detla, self.detla )
            self.db.execute_sql(sql)
